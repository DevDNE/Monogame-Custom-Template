...
public class TitleState : GameState
{
  ...
  public override void Draw(SpriteBatch spriteBatch, GameTime gameTime)
  {
    ...
    const string title = "Dungeon Run";
    ...
    const string sub = "Turn-based dungeon crawler";
    ...
    const string hint = "WASD / Arrows move   Bump monsters to attack   > on stairs to descend";
