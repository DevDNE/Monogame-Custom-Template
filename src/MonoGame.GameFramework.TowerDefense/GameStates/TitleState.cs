...
public class TitleState : GameState
{
  ...
  public override void Draw(SpriteBatch spriteBatch, GameTime gameTime)
  {
    ...
    const string title = "Tower Defense";
    ...
    const string sub = "Place towers, survive 3 waves";
    Vector2 ss = _font.MeasureString(sub);
    spriteBatch.DrawString(_font, sub, new Vector2(_viewportWidth / 2f - ss.X / 2f, 152), new Color(170, 180, 210));
    const string hint = "Click an open cell to place a tower. Each tower costs 20 gold.";
