...
public class TitleState : GameState
{
  ...
  public override void Draw(SpriteBatch spriteBatch, GameTime gameTime)
  {
    ...
    const string sub = "4-lane rhythm — hit notes as they cross the line";
    Vector2 ss = _font.MeasureString(sub);
    spriteBatch.DrawString(_font, sub, new Vector2(_viewportWidth / 2f - ss.X / 2f, 160), new Color(170, 180, 210));
    const string hint = "Keys: D  F  J  K    Esc to quit";
